    ...
    return(
      ...
      <section className="mb-8 glitch" data-text="sobre-mi">
        ...
        <div className="flex flex-wrap gap-4">
          <div className="glitch hover:bg-[#37ff147b] hover:text-black rounded p-1">
            <svg width="30px" height="30px" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="SVGRepo_iconCarrier">
                <path d="M6 2.5H7M4.5 4V1.5C4.5 0.947715 4.94772 0.5 5.5 0.5H9.5C10.0523 0.5 10.5 0.947715 10.5 1.5V6.5C10.5 7.05228 10.0523 7.5 9.5 7.5H5.5C4.94772 7.5 4.5 7.94772 4.5 8.5V13.5C4.5 14.0523 4.94772 14.5 5.5 14.5H9.5C10.0523 14.5 10.5 14.0523 10.5 13.5V11M8 4.5H1.5C0.947715 4.5 0.5 4.94772 0.5 5.5V10.5C0.5 11.0523 0.947715 11.5 1.5 11.5H4.5M7 10.5H13.5C14.0523 10.5 14.5 10.0523 14.5 9.5V4.5C14.5 3.94772 14.0523 3.5 13.5 3.5H10.5M8 12.5H9" stroke="#39ff14"></path>
              </g>
            </svg>
          </div>
          <div className="glitch hover:bg-[#37ff147b] hover:text-black rounded p-1">
            <svg className="tech-icon" width="30px" height="30px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="#000000">
              <g id="SVGRepo_iconCarrier">
          ...
          <div className="glitch hover:bg-[#37ff147b] hover:text-black rounded p-1">
            <svg fill="#39ff14" className="" version="1.1" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 512 512" stroke="#39ff14">
              <g id="SVGRepo_iconCarrier">
