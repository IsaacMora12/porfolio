            ...
            <div className="max-w-2xl">
              {visibleLines.map((line, i) => (
                <div key={i} className="leading-6" style={{ minHeight: '1.5rem' }}>
                  {line.includes('[OK]') ? (
                    <span>
                      <span className="text-oldgreen/60">
                        {'  ['}
                        <span className="font-bold text-oldgreen/60">OK</span>
                        {'] '}
                      </span>
                      <span className="text-oldgreen/60">
                        {line.replace('  [OK] ', '')}
                    ...
                    <span className="text-oldgreen/60 font-bold">{line}</span>
                  ) : (
                    <span className="text-oldgreen/60">{line}</span>
                  )}
                </div>
              ))}
              {/* Blinking cursor */}
          ...
          <div className="px-6 pb-6 relative" style={{ zIndex: 3 }}>
            <div className="max-w-2xl">
              ...
              <div className="h-1.5 bg-neutral-900 border border-neutral-800 overflow-hidden">
                <div
                  className="h-full text-oldgreen/80 bg-oldgreen transition-all duration-300 ease-out"
                  style={{
                    width: `${bootProgress}%`,
